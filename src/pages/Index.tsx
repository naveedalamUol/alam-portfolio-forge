...
const Index = () => {
  ...
  const projects = [{
    ...
    image: '/lovable-uploads/5aca96e5-8c75-4876-9db7-a372b94aa4f0.png',
    tags: ['React', 'TypeScript', 'Dashboard', 'POS'],
    liveUrl: '/pharmacy-pos',
    githubUrl: '#'
  }, {
    title: 'BugSolution Website',
    description: 'Professional business website for BugSolution - a comprehensive platform offering clean, scalable, and reliable tech solutions with modern design and code visualization.',
    image: '/lovable-uploads/0cf4ef99-d56a-460e-b778-28f719f8eca9.png',
    tags: ['React', 'Modern Design', 'Business', 'Responsive'],
    liveUrl: '#',
    githubUrl: '#'
  }];
  const stats = [{
